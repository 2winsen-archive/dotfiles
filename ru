// Ubuntu location /home/<user>/xkb-symbols/ru
...
// *************************************
// Similar to Windows 10 phonetic layout (additional ru keys with ralt switch)
// Command to update layouts: setxkbmap -layout us,lv,ru -variant ,,phonetic
...
xkb_symbols "phonetic" {
    ...
    key <AC11> { [  Cyrillic_softsign,    Cyrillic_SOFTSIGN, Cyrillic_hardsign, Cyrillic_HARDSIGN  ] };
    ...
    key <LatW> { [       Cyrillic_sha,       Cyrillic_SHA, Cyrillic_shcha, Cyrillic_SHCHA  ] };
    ...
    key <LatJ> { [   Cyrillic_shorti,   Cyrillic_SHORTI, Cyrillic_yu, Cyrillic_YU  ] };
